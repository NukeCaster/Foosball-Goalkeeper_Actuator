...
// The Python script can change this value using CONFIG,
// but you still need to physically change the TB6600 DIP switches.
int microstepping = 8;
...
void setup() {
  ...
  Serial.println(F("Commands: CONFIG m speed accel, TEST start target, STOP, X, CLEAR, HOME, STATUS, POS, HEADER"));
  printCSVHeader();
}
